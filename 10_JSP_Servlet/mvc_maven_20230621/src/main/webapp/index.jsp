...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                %>
                <div><%=loginUser.getName()%>님 로그인</div>
                <% } %>
            </div>
        </div>
    </nav>

    <h1 class="h1">Maven MVC 좋아요 게시판</h1>
    <h2>MVC 게시판 목록</h2>
    <ul>
    ...
    <ul>
        <li>워크스페이스를 자동 저장 (저장버튼을 누르면 더 빠르게 저장 후 반영</li>
        <li>**프로젝트를 1개만 실행하는 것을 권장</li>
        <li>대부분의 인코딩이 utf-8로 되어 있음</li>
        <li>서버를 동적리소스(서블릿)의 자동 저장을 반영하지 않음 (코드를 작성할때마다 매번 배포해야하기 때문에 자동배포가 아닌 직접배포를 권장)</li>
    </ul>
</body>
</html>